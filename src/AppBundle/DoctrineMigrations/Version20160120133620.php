...
class Version20160120133620 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('INSERT INTO `product_standard` (`id`, `necktie_id`, `amember_id`, `desktop_billing_plan_id`, `mobile_billing_plan_id`, `notification_status`) VALUES (1,8,NULL,NULL,NULL,NULL),(14,6,7,NULL,NULL,NULL);');
        $this->addSql('INSERT INTO `billing_plan` (`id`, `product_id`, `necktie_id`, `amember_id`, `initial_price`, `rebill_price`, `frequency`, `rebill_times`, `price`) VALUES(3,NULL,NULL,NULL,100,0,0,0,\'$100\'),(4,NULL,NULL,NULL,30,0,0,0,\'$100\'),(5,14,NULL,3,30,0,0,0,\'$30.00\'),(6,14,NULL,44,30,25,14,50,\'$30.00 and 49 times $25.00\'),(7,14,NULL,54,20,30,7,100,\'$20.00 and 99 times $30.00\'),(8,1,NULL,4,60,0,0,0,\'$60.00\'),(9,1,NULL,231,30,30,14,3,\'$30.00 and 2 times $30.00\');');
